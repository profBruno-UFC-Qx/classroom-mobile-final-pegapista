...
fun AtividadeBeforeScreen(
    ...
    val titulo = stringResource(R.string.msg_atividade_iniciada)
    val mensagem = stringResource(R.string.msg_bom_treino_continue_firme)
    val permissionLauncher = rememberLauncherForActivityResult(
        contract = ActivityResultContracts.RequestPermission()
    ) { isGranted ->
        if (isGranted) {
            showNotification(
                context, titulo, mensagem,
                )
            onStartActivity()
        } else {
            onStartActivity()
    ...
    val handleStartClick = {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.TIRAMISU) {
            ...
            if (hasPermission) {
                showNotification(context, titulo, mensagem)
                onStartActivity()
            } else {
    ...
    Column(
        ...
        Column(
            ...
            TituloAtividade(stringResource(R.string.label_tudo_pronto_para_correr))
        ...
        Column(
            ...
            Box(
                ...
                Icon(
                    ...
                    contentDescription = stringResource(R.string.desc_ilustra_o_de_corrida),
            ...
            Box(
                ...
                Text(
                    text = stringResource(R.string.label_corrida),
                    fontWeight = FontWeight.Bold,
                    fontSize = 12.sp,
...
fun AcoesAtividade(
    ...
    Row(
        ...
        BotaoCircularGrande(
            ...
            texto = stringResource(R.string.label_iniciar),
        ...
        BotaoCircularGrande(
            ...
            texto = stringResource(R.string.label_mapa),
            onClick = onMapaClick
        )
    }
}
