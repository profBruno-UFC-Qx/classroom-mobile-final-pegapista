...
fun CadastroScreen(
    ...
    LaunchedEffect(uiState) {
        ...
        if (uiState.isSuccess) {
            Toast.makeText(context, R.string.msg_conta_criada, Toast.LENGTH_LONG).show()
            onCadastroSucesso()
    ...
    Column(
        ...
        Column(
            ...
            Text(
                text = stringResource(R.string.label_crie_sua_conta),
            ...
            CampoCadastro(
                ...
                label = stringResource(R.string.label_nome_completo)
            )
            ...
            CampoCadastro(
                ...
                label = stringResource(R.string.label_confirmar_senha),
                isPassword = true
            )
            ...
            Text(
                text = stringResource(R.string.label_ou_cadastre_se_com),
                fontSize = 12.sp,
                color = Color.Gray,
                modifier = Modifier
...
fun ButtonCadastrar(onClick: () -> Unit) {
    Button(
        ...
        Text(stringResource(R.string.label_cadastrar), fontSize = 15.sp, fontWeight = FontWeight.Bold)
    }
}
